...
export const isDayTimeFromDateTime = (dateTime, forecastDays) => {
  ...
  if (!forecastDay || !forecastDay.astro) return "Zi"; // fallback
  ...
  console.log("🕒 Local date:", date.toISOString());
  console.log("🌄 Sunrise:", forecastDay.astro.sunrise);
  console.log("🌇 Sunset:", forecastDay.astro.sunset);
  console.log("⏱️ Current mins:", currentMins, "| Sunrise:", sunriseMins, "| Sunset:", sunsetMins);
