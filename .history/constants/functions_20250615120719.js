...
export const isDayTimeFromDateTime = (dateTime, forecastDays) => {
  ...
  const timeToMinutes = (timeStr) => {
    // ... (your existing robust timeToMinutes implementation)
  };
  ...
  console.log("Found ForecastDay Astro:", forecastDay.astro);
  ...
  console.log("Current Time (H:M):", `<span class="math-inline">\{localHours\}\:</span>{localMinutes}`, "-> Current Mins:", currentMins);
  console.log("Condition:", currentMins >= sunriseMins && currentMins < sunsetMins ? "Day" : "Night");
  console.log("--- END DEBUG ---");

  if (isNaN(sunriseMins) || isNaN(sunsetMins)) {
    console.error("[isDayTime] Sunrise or Sunset parsing failed. Returning 'Zi'.");
    return "Zi";
  }
