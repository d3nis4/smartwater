...
const apiForecast = process.env.EXPO_PUBLIC_OPEN_WEATHER_FORECAST_API_KEY;
const BASE_URL = process.env.EXPO_PUBLIC_OPEN_WEATHER_BASE_URL;
console.log("Debug: API Key (WeatherAPI.com):", apiKey);

const forecastEndpoint = (params) =>
  `http://api.weatherapi.com/v1/forecast.json?key=${apiKey}&q=${params.cityName}&days=5&aqi=yes&alerts=yes&lang=ro`;
const locationsEndpoint = (params) =>
  `http://api.weatherapi.com/v1/search.json?key=${apiKey}&q=${params.cityName}&hours=24&lang=ro`;
