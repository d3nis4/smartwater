...
export const weatherImages = {
  day: {
    ...
    "Ploi ușoare și de scurtă durată": NorSoarePloaie,
  ...
  night: {
    "Soare": LunaSenin,
    "Senin": LunaSenin,
    "Parțial noros": NorLuna,
    "Noros": NorLuna,
    "Cer acoperit": NorLuna,
    "Ceață": LunaCeata,
    "Ceață densă": LunaCeata,
    "Tunete în apropiere": LunaNorTunet,
    "Ploi moderate": LunaNorPloaie,
    "Ploi uşoare": LunaNorPloaie,
    "Ploi moderate uneori": LunaNorPloaie,
    "Ploi pe porţiuni în apropiere": LunaNorPloaie,
    "Ploi ușoare și de scurtă durată": LunaNorPloaie,
    "Ploi uşoare pe alocuri": LunaNorPloaie,
    "Ploaie torențială": LunaNorPloaie,
    "Ploaie torențială uneori": LunaNorPloaie,
    "Ploai ușoare și de scurtă durată": LunaNorPloaie,
    "Ploaie torențială de scurtă durată": LunaNorPloaie,
    "Ploi de scurtă durată moderate sau în cantităţi însemnate": LunaNorPloaie,
    "Grindină": LunaNorTunet,
    "Ploi în cantităţi mici însoţite de grindină": LunaNorTunet,
    "Ploi în cantităţi mari şi moderate însoțite de grindină": LunaNorTunet,
    "Ploi în cantităţi mici pe porțiuni însoțite de tunete": LunaNorTunet,
    "Ploi în cantităţi mari şi moderate pe porțiuni însoțite de tunete": FurtunaNoaptea,
    "Ninsori pe porţiuni în apropiere": LunaNorNinsoare,
    "Ninsori în cantităţi mici": LunaNorNinsoare,
    "Ninsori în cantităţi mici pe alocuri": LunaNorNinsoare,
    "Ninsori moderate": LunaNorNinsoare,
    "Ninsori moderate pe alocuri": LunaNorNinsoare,
    "Ninsori în cantităţi mari pe porţiuni": LunaNorNinsoare,
    "Ninsori în cantităţi însemnate": LunaNorNinsoare,
    ...
    "Lapoviță de scurtă durată în cantităţi mici": RainAndSleetMix,
    "Lapoviță de scurtă durată în cantităţi mari şi moderate": RainAndSleetMix,
    "Burniță şi polei pe porţiuni în apropiere": LunaCeata,
    "Burniță uşoară pe porțiuni": NorLuna,
    "Burniță uşoară": NorLuna,
    "Burniță înghețată în cantităţi însemnate": LunaCeata,
    "Burniță înghețată": LunaCeata,
    "Chiciură": LunaCeata,
    "Viscol": Tornada,
    "Ninsoare viscolită": Tornada,
    "Vânt": LunaNorVant,
    "Nor cu vânt": LunaNorVant,
  }
};
