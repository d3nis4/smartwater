...
import { EXPO_PUBLIC_OPEN_WEATHER_API_KEY, EXPO_PUBLIC_OPEN_WEATHER_FORECAST_API_KEY, EXPO_PUBLIC_OPEN_WEATHER_BASE_URL } from '@env';
export const apiKey = process.env.EXPO_PUBLIC_OPEN_WEATHER_API_KEY;
