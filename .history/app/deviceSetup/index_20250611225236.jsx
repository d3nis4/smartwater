...
useEffect(() => {
    if (bleConfigSent && user?.email) {
      ...
      const unsubscribeFirebase = onValue(connectionStatusRef, (snapshot) => {
        ...
        if (status === "connected") {
          ...
          saveDeviceLocation();
          // Redirect to home screen after successful configuration
          router.replace('/home'); // Assuming '/home' is your home screen route
  ...
  }, [bleConfigSent, user?.email, safeEmail, router]); // Add 'router' to the dependency array
