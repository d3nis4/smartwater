...
<View style={styles.instructionItem}>
  ...
  <Text style={styles.instructionText}>
    ...
    <Text style={styles.instructionText}>
    6. Din listă, selectează dispozitivul <Text style={styles.highlightText}>"SmartWater"</Text>.
  </Text>
    3. Apasă butonul microcontrolerului — se va aprinde un{" "}
    <Text style={{ color: "blue", fontFamily: "poppins-bold" }}>bec albastru</Text>.{"\n"}
    4. În aplicație, apasă „Connect”, apoi „Bond”.{"\n"}
    5. În timpul conectării Wi-Fi, becul clipește. Dacă se conectează, rămâne aprins. Dacă nu, încearcă din nou.
  </Text>
</View>
