...
const saveDeviceLocation = async () => {
  try {
    ...
    // 2. Salvează numărul de telefon SEPARAT, sub users/{email}/phone
    if (phoneNumber.trim()) {
      await set(ref(db, `users/${safeEmail}/phone`), phoneNumber.trim());
    }
    ...
    Alert.alert("Eroare", "Nu s-a putut salva locația sau numărul de telefon.");
  }
};
