      ...
      <View style={styles.instructionCard}>
        ...
        <View style={styles.instructionItem}>
          ...
          <Text style={styles.instructionText}>
            Activează Bluetooth-ul pe telefon și apasă butonul microcontrolerului, ar trebui sa vezi un bec albastru aprins, in timpul conectarii wi fi becul clipeste iar daca configurarea a reusit becul ramane albastru, altfel se stinge si trebuie incercat dinnou
          </Text>
        </View>
