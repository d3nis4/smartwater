...
const DeviceSetupScreen = () => {
  ...
  const handleConfigureDevice = async () => {
    try {
      ...
      if (!bleConfigSent) {
        // If BLE failed before sending config, then stop spinner
  ...
  return (
    ...
    <View style={styles.instructionItem}>
      ...
      <Text style={styles.instructionText}>
        Activează Bluetooth-ul pe telefon și apasă butonul microcontrolerului, ar trebui să vezi un{' '}
        <Text style={{ fontWeight: 'bold', color: 'blue', fontFamily:"poppins"}}>bec albastru</Text>{' '}
        aprins. În timpul conectării Wi-Fi, becul clipește, iar dacă configurarea a reușit, becul rămâne albastru.
        Altfel, se stinge și trebuie să încercat din nou.
      </Text>
    </View>
