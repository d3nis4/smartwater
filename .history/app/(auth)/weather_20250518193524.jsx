        ...
        <>
          ...
          <View style={styles.modalHeader}>
            ...
            <TouchableOpacity onPress={() => setSelectedForecast(null)}>
              <Icon name="close" size={24} color="#4A6FA5" />
            </TouchableOpacity>
          </View>
          ...
          <View style={styles.detailsGrid}>
            ...
            <View style={styles.detailItem}>
              <Feather name="arrow-up" size={18} color="#4A6FA5" />
            ...
            <View style={styles.detailItem}>
              <Feather name="thermometer" size={18} color="#4A6FA5" />
            ...
            <View style={styles.detailItem}>
              <Feather name="droplet" size={18} color="#4A6FA5" />
              <Text style={styles.detailLabel}>Umiditate</Text>
              <Text style={styles.detailValue}>
            ...
            <View style={styles.detailItem}>
              <Feather name="wind" size={18} color="#4A6FA5" />
              <Text style={styles.detailLabel}>Vânt</Text>
              <Text style={styles.detailValue}>
            ...
            <View style={styles.detailItem}>
              <Feather name="compass" size={18} color="#4A6FA5" />
              <Text style={styles.detailLabel}>Direcție</Text>
              <Text style={styles.detailValue}>
            ...
            {selectedForecast.rain && (
              <View style={styles.detailItem}>
                <Feather name="cloud-rain" size={18} color="#4A6FA5" />
                <Text style={styles.detailLabel}>Precipitații</Text>
                <Text style={styles.detailValue}>
