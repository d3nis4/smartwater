...
const weatherKey = weather?.forecast?.forecastday[0]?.condition?.text?.trim();
const imageSource = weatherKey && weatherImages[weatherKey] ? weatherImages[weatherKey] : { uri: `https:${current?.condition?.icon}` };
