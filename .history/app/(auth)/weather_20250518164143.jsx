...
function isDayTimeFromDateTimeLocal(dateTimeStr, forecastDays) {
  const inputDate = new Date(dateTimeStr); // presupunem că e în format ISO local sau cu T
  ...
  // Construim datele de răsărit și apus în fusul local (nu UTC)
