...
export default function Home() {
 ...
 const onTimeSelected = (event, selectedDate) => {
  // Pe iOS, picker-ul nu se închide automat după selecție, pe Android da.
  setPickerVisible(Platform.OS === 'ios'); 

  if (event.type === 'set' && selectedDate) { // 'set' înseamnă că utilizatorul a apăsat OK/Done
    ...
    // Dacă utilizatorul a anulat picker-ul (event.type === 'dismissed' pe Android)
    // sau nu a selectat o dată (selectedDate este null/undefined pe iOS când anulezi)
    setPickerVisible(false); // Asigură că picker-ul se închide și pe iOS
  }
};
  // --------------------------------------------Firebase instances
  const auth = getAuth();
