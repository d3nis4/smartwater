...
{selectedHour && (() => {
  const isDay = isDayTimeFromDateTime(selectedHour.time, weather.forecast.forecastday);
  const isDayBool = isDay === "Zi";
        ...
        <View style={styles.modalHeader}>
          ...
          <View style={styles.weatherIconContainer}>
            <Image
              ...
              resizeMode="contain"
            />
            <Text style={styles.modalCondition}>{selectedHour.condition.text}</Text>
          </View>
        </View>
        ...
        <View style={styles.detailsContainer}>
          <View style={styles.detailRow}>
            <View style={styles.detailItem}>
              <Feather name="thermometer" size={20} color={Colors.GREEN} />
          ...
          <View style={styles.detailRow}>
            <View style={styles.detailItem}>
              <Feather name="droplet" size={20} color={Colors.GREEN} />
          ...
          <View style={styles.detailRow}>
            <View style={styles.detailItem}>
              <Feather name="cloud-rain" size={20} color={Colors.GREEN} />
    ...
    <Text style={styles.modalWeatherDesc}>
      {selectedForecast.weather[0].description}
          ...
          <View style={styles.detailsGrid}>
            <View style={styles.detailItem}>
              <Feather name="arrow-down" size={18} color={Colors.} />
            ...
            <View style={styles.detailItem}>
              <Feather name="arrow-up" size={18} color={Colors.} />
            ...
            <View style={styles.detailItem}>
              <Feather name="thermometer" size={18} color={Colors.} />
            ...
            <View style={styles.detailItem}>
              <Feather name="droplet" size={18} color={Colors.} />
              <Text style={styles.detailLabel}>Umiditate</Text>
              <Text style={styles.detailValue}>
            ...
            <View style={styles.detailItem}>
              <Feather name="wind" size={18} color={Colors.} />
              <Text style={styles.detailLabel}>Vânt</Text>
              <Text style={styles.detailValue}>
            ...
            <View style={styles.detailItem}>
              <Feather name="compass" size={18} color={Colors.} />
              <Text style={styles.detailLabel}>Direcție</Text>
              <Text style={styles.detailValue}>
            ...
            <View style={styles.detailItem}>
              <Feather name="activity" size={18} color={Colors.} />
              <Text style={styles.detailLabel}>Șanse ploaie</Text>
              <Text style={styles.detailValue}>
            ...
            {selectedForecast.rain && (
              <View style={styles.detailItem}>
                <Feather name="cloud-rain" size={18} color={Colors.} />
                <Text style={styles.detailLabel}>Precipitații</Text>
                <Text style={styles.detailValue}>
