        ...
        <View style={styles.statusCard}>
          ...
          <Text style={styles.bullet}>
            ...
            {Math.floor(stats.durataTotala / 60) > 0
              ? `${Math.floor(stats.durataTotala / 60)} ${
                  Math.floor(stats.durataTotala / 60) === 1 ? "oră" : "ore"
                }`
              : ""}
            {Math.floor(stats.durataTotala / 60) > 0 &&
            stats.durataTotala % 60 > 0
              ? " și "
              : ""}
            {stats.durataTotala % 60 > 0
              ? `${stats.durataTotala % 60} ${
                  stats.durataTotala % 60 === 1 ? "minut" : "minute"
                }`
              : ""}
