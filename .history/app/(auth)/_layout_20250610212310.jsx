...
export default function AuthLayout() {
  ...
  const startHexColor = 'rgba(255, 255, 255, 0.82)'; // Culoarea de sus a gradientului (mai transparentă)
  const endHexColor = '#c2e9fb';   // Culoarea de jos a gradientului (mai opacă)

  const startAlpha = 1.0;   // Opac sus (alb complet)
const endAlpha = 0.0;     // Transparent jos
const numSteps = 20;
const fadeColors = [];
