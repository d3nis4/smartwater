...
const WeatherComponent = () => {
  ...
  const [weather, setWeather] = useState({});
    useEffect(() => {
    // Simulare fetch date meteo după 1s
    setTimeout(() => {
      setWeatherData({
        location: { localtime: "2025-05-18 14:30" },
        current: {
          condition: { text: "Soare", icon: "//example.com/icon.png" },
        },
        forecast: {
          forecastday: [
            {
            ...
            {
              date: "2025-05-19",
              astro: { sunrise: "06:01 AM", sunset: "08:29 PM" },
              hour: [ /* orele zilei */ ],
            },
          ],
        },
 ...
 if (!weather?.current || !weather?.forecast) {
  return <Text>Se încarcă datele meteo...</Text>;
}
...
const currentHourTime = weather.location.localtime;
const isDay = isDayTimeFromDateTime(currentHourTime, weather);
