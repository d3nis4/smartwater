...
const Home = () => {
  ...
  return (
    ...
    {/* Text care indică statusul override-ului */}
    {overrideActive && (
      <Text style={{ color: "orange", textAlign: "center", marginBottom: 5 }}>
        Override activ: Pompa este oprită
      </Text>
    )}

    {/* Butonul pentru a porni pompa manual */}
    {overrideActive && (
      <TouchableOpacity
        onPress={handleOverrideStart}
        style={{
          backgroundColor: "#2ecc71", // Culoare verde pentru "Pornește"
          padding: 12,
          borderRadius: 10,
          alignItems: "center",
          marginHorizontal: 20,
      ...
      >
        <Text style={{ color: "white", fontWeight: "bold" }}>
          Pornește pompa manual (Override dezactivat)
        </Text>
      </TouchableOpacity>
    )}
