...
const imageSource = weatherImages[weather?.forecast?.forecastday[0]?.condition?.text.trim()] || { uri: `https:${current?.condition?.icon}` };

console.log("🔍 Imaginea selectată pentru vreme:", imageSource);
