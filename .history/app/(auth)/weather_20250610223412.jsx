...
export default function  WeatherComponent(){
  ...
  const getBackgroundImage = (tempC) => {
  if (tempC >= 30) return require('../../assets/background/hot.png');
  if (tempC >= 20) return require('../../assets/background/warm.png');
 ...
 const handlePressOutside = () => {
    setLocations([]); // Ascunde lista de sugestii când se apasă în afara ei
  };
  return (
      <ImageBackground
      ...
      <View style={styles.container}>
        <View style={styles.searchContainer}>
          <TextInput
            ...
            placeholderTextColor="rgba(81, 80, 80, 0.7)"
            value={searchQuery}
            onChangeText={(text) => {
              setSearchQuery(text);
              fetchLocationSuggestions(text); // Actualizează sugestiile la fiecare modificare
            }}
          />
          <TouchableOpacity
              ...
              >
                <View
                  style={[
                    ...
                    index === locations.length - 1 ? null : styles.suggestionBorder,
                  ]}
                >
                  <Ionicons
                    name="location"
