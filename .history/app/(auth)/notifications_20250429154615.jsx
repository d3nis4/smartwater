...
const Notifications = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      {lastWateringDate && Array.isArray(lastWateringInterval) && lastWateringInterval.length > 0 ? (
  <View style={styles.lastActivation}>
    ...
    <View style={styles.activationInfo}>
      ...
      <Text style={styles.activationText}> {formatDateReadable(lastWateringDate)}</Text>
    </View>
