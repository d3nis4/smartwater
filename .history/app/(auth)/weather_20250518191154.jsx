      ...
      {selectedHour && (
        <>
          <Text style={styles.modalTitle}>
            Detalii pentru {selectedHour.time}
          </Text>
          ...
          <Text style={styles.modalText}>
            Condiție: {selectedHour.condition.text}
          </Text>
          <Text style={styles.modalText}>
          ...
          <Text style={styles.modalText}>
            Vânt: {selectedHour.wind_kph} km/h din {selectedHour.wind_dir}
          </Text>
          <Text style={styles.modalText}>
            Presiune: {selectedHour.pressure_mb} mb
          </Text>
          <Text style={styles.modalText}>
            Șanse de ploaie: {selectedHour.chance_of_rain}%
          </Text>
