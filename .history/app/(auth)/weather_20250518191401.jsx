    ...
    <View style={styles.modalOverlay}>
      <View style={styles.modalContainer}>
        <Text style={styles.modalTitle}>
          {new Date(selectedHour.time).getHours()}:00 - {selectedHour.condition.text}
        </Text>
        ...
        <Text style={styles.modalInfo}>
          🌡 Temperatură: {selectedHour.temp_c}°C
        </Text>
        <Text style={styles.modalInfo}>
          🧊 Se simte ca: {selectedHour.feelslike_c}°C
        </Text>
        <Text style={styles.modalInfo}>
          💧 Umiditate: {selectedHour.humidity}%
        </Text>
        <Text style={styles.modalInfo}>
          💨 Vânt: {selectedHour.wind_kph} km/h ({selectedHour.wind_dir})
        </Text>
        <Text style={styles.modalInfo}>
          📈 Presiune: {selectedHour.pressure_mb} mb
        </Text>
        <Text style={styles.modalInfo}>
          🌧️ Ploaie: {selectedHour.chance_of_rain}% ({selectedHour.precip_mm} mm)
        </Text>
