    ...
    <Text style={styles.modalWeatherDesc}>
      {selectedForecast.weather[0].description}
          ...
          <View style={styles.detailsGrid}>
            ...
            <View style={styles.detailItem}>
              <Feather name="arrow-up" size={18} color={Colors.GREEN} />
            ...
            <View style={styles.detailItem}>
              <Feather name="thermometer" size={18} color={Colors.GREEN} />
            ...
            <View style={styles.detailItem}>
              <Feather name="droplet" size={18} color={Colors.GREEN} />
              <Text style={styles.detailLabel}>Umiditate</Text>
              <Text style={styles.detailValue}>
            ...
            <View style={styles.detailItem}>
              <Feather name="compass" size={18} color={Colors.GREEN} />
              <Text style={styles.detailLabel}>Direcție</Text>
              <Text style={styles.detailValue}>
            ...
            {selectedForecast.rain && (
              <View style={styles.detailItem}>
                <Feather name="cloud-rain" size={18} color={Colors.GREEN} />
                <Text style={styles.detailLabel}>Precipitații</Text>
                <Text style={styles.detailValue}>
