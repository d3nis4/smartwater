import { View, Text, Image, TouchableOpacity, Keyboard, ActivityIndicator,.TouchableWithoutFeedback TextInput, Alert } from 'react-native';
...
export default function Profile() {
  ...
  return (
    <View style={{
      ...
      <TouchableOpacity style={[styles.button, { marginBottom: 50 }]} onPress={onSignOutPress}>
