...
import { Colors} from "../../constants/Colors";
 ...
 import { getSafeEmail, calculateDuration,calculateDurationMinutes,formatDateReadable} from "../../constants/functions";
...
export default function  Notifications(){
 ...
 const unsubscribeEmail = onValue(emailRef, (snapshot) => {
    ...
    if (data && (data.soilHumidity !== undefined && data.soilHumidity !== null)) {
      ...
      console.log("soilHumidity is undefined, null, or not present in Firebase data.");
    }
  });
