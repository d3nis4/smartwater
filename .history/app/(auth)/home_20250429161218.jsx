...
const Home = () => {
  ...
  useEffect(() => {
    const checkOverrideStatus = async () => {
      ...
      try {
        ...
        const snapshot = await get(ref(db, `users/${safeEmail}/controls/override`));
 ...
 <TouchableOpacity
  onPress={overrideActive ? handleOverrideStart : handleOverrideStop}
  style={{
    backgroundColor: overrideActive ? Colors.RED : Colors.GREEN, // verde pt pornire, roșu pt oprire
    padding: 12,
    borderRadius: 10,
    alignItems: "center",
    marginHorizontal: 20,
...
>
  <Text style={{ color: "white", fontWeight: "bold" }}>
    {overrideActive ? "Pornește pompa (dezactivează override)" : "Oprește pompa (override activ)"}
  </Text>
</TouchableOpacity>
