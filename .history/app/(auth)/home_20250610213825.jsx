...
const styles = StyleSheet.create({
  ...
  gradientOverlay: {
    ...
    backgroundColor: Colors.WHITEGREEN, // Culoarea care se suprapune
    opacity: 0.2, // Transparența pentru efectul de "fade" (ajustează de la 0.1 la 0.5)
  ...
  userImage: {
    ...
    marginRight: 15,
    borderWidth: 2,
    borderColor: "rgba(255,255,255,0.4)", // Un chenar mai vizibil
  },
  welcomeText: {
    fontFamily: "poppins",
