...
>
  <View style={styles.modalOverlay}>
    <View style={styles.modalContent}>
      ...
      {selectedHour && (
        <>
          <Text style={[styles.modalTime, { fontFamily: "Poppins-Bold" }]}>
            {new Date(selectedHour.time).getHours()}:00
          </Text>

          {/* Folosește iconSource aici */}
          <Image
            source={
              weatherImages[
                selectedHour.is_day ? "day" : "night"
          ...
          <Text style={[styles.modalTemp, { fontFamily: "Poppins-Bold" }]}>
            {Math.round(selectedHour.temp_c)}°C
          </Text>

          <Text style={[styles.modalCondition, { fontFamily: "Poppins" }]}>
            {selectedHour.condition.text}
          </Text>

          <View style={styles.modalDetails}>
            <Text style={{ fontFamily: "Poppins" }}>Precipitații: {selectedHour.precip_mm} mm</Text>
            <Text style={{ fontFamily: "Poppins" }}>Umiditate: {selectedHour.humidity}%</Text>
            <Text style={{ fontFamily: "Poppins" }}>Vânt: {selectedHour.wind_kph} km/h</Text>
            {/* Mai poți adăuga alte detalii relevante */}
          </View>
        </>
      )}
    </View>
...
hourlyTemp: {
  fontSize: 16,
  fontWeight: "bold",          // păstrezi bold
  marginBottom: 5,
  fontFamily: "Poppins-Bold",  // font bold
},
