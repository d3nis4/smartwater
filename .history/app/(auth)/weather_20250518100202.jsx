...
console.log("📅 forecastday[0]:", weather?.forecast?.forecastday?.[0]);
console.log("☁️ condition:", weather?.forecast?.forecastday?.[0]?.condition?.text);
console.log("📝 text:", weather?.forecast?.forecastday?.[0]?.condition?.text);
                      ...
                      <View style={{ flex: 1,marginBottom:20}}>
                        ...
                        <View style={{ alignItems: 'flex-start' }}>
                          <Image
                            ...
                            source={weatherImages[{current?.condition?.text}.trim()] || { uri: `https:${current?.condition?.icon}` }}
                          />
                        </View>
                      </View>
