  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.loginForm}>
        ...
        <View style={{ marginBottom: 20, padding: 10, backgroundColor: "#e0f7fa", borderRadius: 8 }}>
  <Text style={{ fontSize: 16, fontWeight: "500", color: "#006064" }}>
    🔧 Înainte de a continua:
  </Text>
  <Text style={{ marginTop: 5, color: "#004d40" }}>
    - Activează Bluetooth-ul pe telefonul tău
  </Text>
  <Text style={{ color: "#004d40" }}>
    - Selectează dispozitivul <Text style={{ fontWeight: "bold" }}>"SmartWater"</Text> din lista de dispozitive disponibile
  </Text>
</View>
