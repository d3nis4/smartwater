...
export const apiForecast = process.env.OPEN_WEATHER_FORECAST_API_KEY; // This line already gets it from process.env
export const BASE_URL = process.env.OPEN_WEATHER_BASE_URL; // This line already gets it from process.env
