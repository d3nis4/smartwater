...
const handleBothActions = async () => {
  ...
  <Text style={styles.instructionText}>• Activează Bluetooth-ul pe telefonul tău</Text>
  <Text style={styles.instructionText}>
    • Selectează dispozitivul <Text style={{ fontWeight: "600" }}>"SmartWater"</Text> din lista de dispozitive
  </Text>
