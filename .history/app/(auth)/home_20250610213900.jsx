...
<View style={styles.header}>
      {/* Overlay-ul absolut pentru efectul de "fade" de opacitate/culoare */}
      {/* Trebuie să fie primul copil al header-ului pentru a fi dedesubt,
          sau să folosești zIndex dacă ai și alte elemente de fundal */}
      <View style={styles.gradientOverlay} />

      {/* Conținutul header-ului, flexibil pentru a aranja user info și logo */}
...
const styles = StyleSheet.create({
  container: {
   ...
   header: {
    // Padding vertical și orizontal pentru conținutul interior
    paddingHorizontal: 20,
    paddingVertical: 15, // Ajustat pentru un aspect mai modern
    paddingTop: 5, // Poate fi ajustat sau eliminat dacă paddingVertical este suficient

    // Culorile și formele de bază ale header-ului
    backgroundColor: Colors.PRIMARY, // Culoarea de bază a header-ului
    borderBottomLeftRadius: 80,
    borderBottomRightRadius: 80,
    
    // Umbre subtile pentru adâncime
    shadowColor: Colors.SHADOW_COLOR, // Folosim o culoare definită pentru umbră
    shadowOffset: { width: 0, height: 5 }, // Umbră mai pronunțată pe verticală
    shadowOpacity: 0.2, // O opacitate puțin mai mare pentru umbră
    shadowRadius: 15, // Rază mai mare pentru o umbră mai soft
    elevation: 8, // Pentru Android
    
    marginBottom: 15, // Spațiu sub header
    overflow: 'hidden', // IMPORTANT: Asigură că overlay-ul se decupează la marginile rotunjite
  },
  gradientOverlay: {
    ...StyleSheet.absoluteFillObject, // Face ca overlay-ul să ocupe tot spațiul părinte
    backgroundColor: Colors.DARKGREEN, // Culoarea care se suprapune
    opacity: 0.7, // Transparența pentru efectul de "fade" (ajustează de la 0.1 la 0.5)
                 // O valoare mai mică face efectul mai subtil.
    borderBottomLeftRadius: 80, // Asigură că și overlay-ul are colțuri rotunjite
    borderBottomRightRadius: 80,
  },
  // Wrapper pentru conținutul header-ului (user info + logo)
  headerContentWrapper: {
    flexDirection: "row", // Așează elementele pe orizontală
    justifyContent: "space-between", // Spațiază user info la stânga și logo la dreapta
    alignItems: "center", // Centrează vertical elementele
    paddingVertical: 10, // Adaugă un padding intern dacă este necesar
    position: 'relative', // Asigură că e deasupra overlay-ului dacă nu e deja
    zIndex: 1, // Asigură că este deasupra gradientOverlay
  },
  userInfo: {
    flexDirection: "row",
    alignItems: "center",
  ...
  userImage: {
    width: 55, // Mărește puțin imaginea pentru a fi mai proeminentă
    height: 55,
    borderRadius: 30, // Asigură o rotunjire perfectă
    marginRight: 15,
    borderWidth: 2,
    borderColor: "rgba(255, 255, 255, 0.93)", // Un chenar mai vizibil
  },
  welcomeText: {
    fontFamily: "poppins",
    color: Colors.TEXT_LIGHT,
    fontSize: 14,
    // marginBottom: -3, // Ajustează spațierea între welcome și username
  },
  userName: {
    fontSize: 22, // Mărește numele de utilizator
    color: Colors.TEXT_WHITE,
    fontFamily: "poppins-bold",
    // Poate adăuga un text shadow subtil pentru un efect mai pop
    textShadowColor: 'rgba(0,0,0,0.1)',
    textShadowOffset: {width: 1, height: 1},
    textShadowRadius: 2,
  },
  logo: {
    width: 45, // Ajustează dimensiunea logo-ului
    height: 45,
    resizeMode: "contain", // Asigură că logo-ul se încadrează fără a fi tăiat
  },
  cardsContainer: {
    flexDirection: "row",
