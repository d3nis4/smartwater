    ...
    for (let i = 0; i < schedule.length; i++) {
      ...
      for (let j = 0; j < timeSlots.length; j++) {
        ...
        if (startMinutes === endMinutes) {
          Alert.alert(
            "Interval invalid",
            `În ziua ${days[i]}, intervalul ${interval} nu este valid.`
          );
          return;
        }
        ...
        if (startMinutes >= endMinutes) {
         Alert.alert(
            "Interval invalid",
            `În ziua ${days[i]}, intervalul ${interval} nu este valid deoarece ora de început nu poate fi egală cu ora de sfârșit.`
          );
          return;
        }
        ...
        if (endMinutes - startMinutes < 1) {
          Alert.alert(
            "Interval prea scurt",
            `Intervalul de irigare din ziua ${days[i]} trebuie să dureze cel puțin 1 minut.`
          );
          return;
        }
        ...
        if (endMinutes - startMinutes > 120) {
          Alert.alert(
            "Interval prea lung",
            `Intervalul de irigare din ziua ${days[i]} nu poate dura mai mult de 2 ore.`
          );
          return;
        }
      }
