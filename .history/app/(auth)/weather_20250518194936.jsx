...
>
  ...
  const iconSource = weatherImages[isDayBool ? "day" : "night"][conditionKey] || {
      ...
      >
        <TouchableOpacity activeOpacity={1} style={styles.modalContainer}>
          ...
          <View style={styles.detailsContainer}>
            ...
            <View style={styles.detailRow}>
              <Feather name="wind" size={20} color="#4CAF50" />
            ...
            <View style={styles.detailRow}>
              <Feather name="compass" size={20} color="#4CAF50" />
              <Text style={styles.detailLabel}>Direcție vânt:</Text>
              <Text style={styles.detailValue}>{selectedHour.wind_dir}</Text>
            </View>

            <View style={styles.detailRow}>
              <Feather name="cloud-rain" size={20} color="#4CAF50" />
