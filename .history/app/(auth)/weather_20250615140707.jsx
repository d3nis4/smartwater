...
export const BASE_URL = process.env.EXPO_PUBLIC_OPEN_WEATHER_BASE_URL;
                ...
                >
                  ...
                  <Card style={styles.mapCard}>
                    ...
                    >
                      ...
                      {/* Precipitații */}
                      <UrlTile
                        urlTemplate={`${BASE_URL}/precipitation_new/{z}/{x}/{y}.png?appid=${open_weather_key}&lat=${
                      ...
                      {/* Temperatură */}
                      <UrlTile
                        urlTemplate={`${BASE_URL}/temp_new/{z}/{x}/{y}.png?appid=${open_weather_key}&lat=${
                          weather?.location?.lat || 44.4268
                        }&lon=${weather?.location?.lon || 26.1025}`}
                        maximumZ={19}
                        flipY={false}
