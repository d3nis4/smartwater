...
pumpStatusContainer: {
  ...
  justifyContent: 'center',  // aliniază pe verticală
  alignItems: 'center',  // aliniază pe orizontală
},
pumpButtons: {
  flexDirection: 'row',  // aranjează butoanele pe orizontală
  justifyContent: 'center',  // asigură că butoanele sunt centrate pe axa orizontală
  alignItems: 'center',  // aliniează butoanele pe axa verticală
},
pumpButton: {
  margin: 10,  // adaugă puțin spațiu între butoane
  padding: 15,  // adaugă puțin padding pentru un aspect mai mare
  borderRadius: 5,  // face colțurile butoanelor mai rotunjite
},
pumpOnButton: {
  backgroundColor: 'green',  // culoare pentru butonul de pornire
},
pumpOffButton: {
  backgroundColor: 'red',  // culoare pentru butonul de oprire
},
buttonText: {
  color: 'white',  // culoare textului pe buton
  fontSize: 16,  // mărimea textului
  textAlign: 'center',  // alinierea textului în mijloc
},
});
