...
const styles = StyleSheet.create({
  container: {
    ...
    // Culoarea de bază SOLIDĂ a header-ului (fără fade aici)
    backgroundColor: Colors.PRIMARY,
    borderBottomLeftRadius: 80,
    borderBottomRightRadius: 80,
    
    // Umbre pentru adâncime
    shadowColor: Colors.SHADOW_COLOR,
    shadowOffset: { width: 0, height: 6 }, // O umbră mai pronunțată pe verticală
    shadowOpacity: 0.25, // O opacitate mai mare pentru umbră
    shadowRadius: 20, // O rază mai mare pentru o umbră mai soft și modernă
    elevation: 10, // Pentru Android
    
    marginBottom: 15,
    overflow: 'hidden', // ESENȚIAL: Asigură că imaginea pattern-ului se decupează la marginile rotunjite
  },
  // Stilul pentru imaginea de fundal cu pattern
  patternBackground: {
    ...StyleSheet.absoluteFillObject, // Face ca imaginea să ocupe tot spațiul header-ului
    resizeMode: 'repeat', // Foarte important: face ca imaginea să se repete pentru a umple spațiul
                          // Alternativ: 'cover' dacă pattern-ul este o singură imagine mare
    opacity: 0.1, // Ajustează opacitatea pattern-ului pentru a fi subtil.
                 // Cu cât e mai mică, cu atât culoarea de bază (Colors.PRIMARY) iese mai mult în evidență.
    // Asigură-te că și pattern-ul respectă colțurile rotunjite
    borderBottomLeftRadius: 80,
    borderBottomRightRadius: 80,
  },
  ...
  headerContentWrapper: {
    ...
    alignItems: "center",
    paddingVertical: 10,
    position: 'relative', // Creează un context de stivuire
    zIndex: 1, // Crucial: Asigură că textul și imaginile sunt deasupra pattern-ului de fundal
  },
  userInfo: {
    flexDirection: "row",
    alignItems: "center",
  ...
  userImage: {
    width: 60, // Mărește puțin imaginea
    height: 60,
    borderRadius: 30,
    marginRight: 15,
    borderWidth: 2,
    borderColor: "rgba(255,255,255,0.5)", // Un chenar mai vizibil și modern
  },
  welcomeText: {
    fontFamily: "poppins",
  ...
  userName: {
    fontSize: 24, // Mărește și mai mult numele
    color: Colors.TEXT_WHITE,
    fontFamily: "poppins-bold",
    textShadowColor: 'rgba(0,0,0,0.15)', // O umbră de text subtilă
    textShadowOffset: {width: 1, height: 1},
    textShadowRadius: 3,
  },
  logo: {
    width: 50, // Ajustează dimensiunea logo-ului
    height: 50,
    resizeMode: "contain",
  },
  cardsContainer: {
