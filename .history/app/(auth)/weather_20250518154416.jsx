...
const currentHourTime = new Date().toISOString().slice(0, 19).replace('T', ' '); // ora locală format YYYY-MM-DD HH:mm:ss
const isDay = isDayTimeFromDateTime(currentHourTime, weather.forecast.forecastday[0]);
