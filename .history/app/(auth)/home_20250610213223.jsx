...
const styles = StyleSheet.create({
  ...
  gradientOverlay: {
    ...StyleSheet.absoluteFillObject,  // ocupă tot header-ul
    backgroundColor: Colors.WHITEGREEN, // culoarea deschisă
    opacity: 0.3,                       // transparență pentru efect gradient
    borderRadius: 20,                   // rotunjire colțuri, dacă vrei
    transform: [{ translateY: -20 }],  // mutăm puțin în sus pentru efect
  },
  headerContent: {
    zIndex: 2, // să fie deasupra overlay-ului
    flexDirection: 'row',
    alignItems: 'center',
