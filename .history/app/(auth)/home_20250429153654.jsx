...
const Home = () => {
  ...
  const handleOverrideStop = async () => {
    ...
    try {
      ...
      // Dezactivează override-ul după un timp (ex: 10 minute) dacă vrei automat
      setTimeout(() => {
        ...
        {pumpMode === "auto" && (
         ...
         {pumpMode === "smart" && (
          <View style={styles.autoModeContainer}>
            ...
            <Text style={styles.autoModeText}>
              Pompa va funcționa automat in functie de parametrii de mediu: prognoza meteo, temperatura, umiditate
            </Text>
            <View style={styles.thresholdControl}>
            </View>
