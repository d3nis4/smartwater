...
function isDayTimeFromDateTime(dateTimeStr: string, forecastDays: ForecastDay[]): boolean {
  const inputDate = new Date(dateTimeStr); // ex: "2025-05-19 03:00"
  const inputDateStr = inputDate.toISOString().split("T")[0]; // "2025-05-19"
