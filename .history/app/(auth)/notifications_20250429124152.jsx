...
import { View, Text, StyleSheet, FlatList, TouchableOpacity, toFixed } from 'react-native';
        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            <View style={styles.historyItem}>
              ...
              <Text>Umiditate: <Text style={styles.boldText}>
                {item.soilHumidity || '--'}%
              </Text></Text>
              <Text>Temperatură: <Text style={styles.boldText}>
