...
<View style={styles.statsGrid}>
  ...
  <View style={styles.statItem}>
    ...
    />
    <Text style={[styles.statLabel, dynamicStyles.text]}>Viteză vânt</Text>
  ...
  <View style={styles.statItem}>
    <Feather
      ...
      style={styles.statIcon}
    />
    <Text style={[styles.statLabel, dynamicStyles.text]}>Umiditate</Text>
    <Text style={[styles.statValue, dynamicStyles.text]}>
      {current?.humidity}%
    </Text>
  </View>
  ...
  <View style={styles.statItem}>
    <Feather
      ...
      style={styles.statIcon}
    />
    <Text style={[styles.statLabel, dynamicStyles.text]}>Index UV </Text>
    <Text style={[styles.statValue, dynamicStyles.text]}>
      {weather?.current?.uv}
    </Text>
  </View>
  ...
  <View style={styles.statItem}>
    <Feather
      ...
      style={styles.statIcon}
    />
    <Text style={[styles.statLabel, dynamicStyles.text]}>Acoperire nori</Text>
    <Text style={[styles.statValue, dynamicStyles.text]}>
  ...
  <View style={styles.statItem}>
    <Feather
      ...
      style={styles.statIcon}
    />
    <Text style={[styles.statLabel, dynamicStyles.text]}>Șansă ninsoare</Text>
    <Text style={[styles.statValue, dynamicStyles.text]}>
  ...
  <View style={[styles.sunTimeContainer]}>
    <View style={styles.sunTimeItem}>
      <Feather
        ...
        style={styles.statIcon}
      />
      <Text style={[dynamicStyles.text, styles.sunTimeLabel]}>Răsărit</Text>
    ...
    <View style={styles.sunTimeItem}>
      <Feather
        ...
        style={styles.statIcon}
      />
      <Text style={[dynamicStyles.text, styles.sunTimeLabel]}>Apus</Text>
      <Text style={[dynamicStyles.text, styles.sunTimeValue]}>
                  ...
                  >
                    ...
                    <View style={{ alignItems: "flex-end", marginTop: 20 }}>
                      <Text
                        style={[
                          dynamicStyles.text,
                          { fontSize: 30, fontWeight: "200",fontFamily:"poppins" },
                        ]}
                      >
...
<View style={styles.statsGrid}>
  ...
  <View style={styles.statItem}>
    <Feather
      ...
      size={24}
      color={
        current?.temp_c > 10 ? "rgba(0,0,0,0.8)" : "rgba(255,255,255,0.9)"
      }
    />
          ...
          >
            ...
            >
              <TouchableOpacity activeOpacity={1} style={styles.modalContainer}>
                {selectedForecast && (const iconCode = selectedForecast.weather[0].icon;
  const isNight = iconCode.includes("n");

  const weatherDescriptionMap = {
    "clear sky": isNight ? "Senin noaptea" : "Senin",
    "few clouds": isNight ? "Parțial noros noaptea" : "Parțial noros",
    "scattered clouds": isNight ? "Noros noaptea" : "Noros",
    "broken clouds": isNight ? "Cer acoperit noaptea" : "Cer acoperit",
    "shower rain": isNight ? "Ploi uşoare noaptea" : "Ploi uşoare",
    "light rain": isNight ? "Ploi uşoare noaptea" : "Ploi uşoare",
    "moderate rain": isNight ? "Ploi moderate noaptea" : "Ploi moderate",
    "rain": isNight ? "Ploi moderate noaptea" : "Ploi moderate",
    "thunderstorm": isNight ? "Tunete în apropiere noaptea" : "Tunete în apropiere",
    "snow": isNight ? "Ninsori moderate noaptea" : "Ninsori moderate",
    "light snow": isNight ? "Ninsori în cantităţi mici noaptea" : "Ninsori în cantităţi mici",
    "mist": isNight ? "Ceață noaptea" : "Ceață",
  };

  const description = selectedForecast.weather[0].description;
  const translated = weatherDescriptionMap[description] || "Senin";
  const localImage = isNight
    ? weatherImages.night[translated]
    : weatherImages.day[translated];
                  <>
                    {/* Header */}
                    <View style={styles.modalHeader}>
                      {(() => {
                    ...
                    <View style={styles.modalWeatherMain}>
                     <Image 
  source={getLocalWeatherImage(selectedForecast.weather[0].icon)}
