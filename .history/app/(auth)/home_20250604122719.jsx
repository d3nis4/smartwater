...
import DeviceSetupScreen from "./_DeviceSetupScreen";
...
const [isConfigured, setIsConfigured] = useState(null);
  ...
  if (!isConfigured) {
    // Dacă device-ul nu e configurat, fie redirecționezi
    router.replace('/_DeviceSetupScreen');

    // Sau afișezi un mesaj simplu, până face redirect
    return (
      <View style={{ flex:1, justifyContent: 'center', alignItems: 'center' }}>
        <Text>Trebuie să configurezi device-ul înainte de a folosi aplicația.</Text>
      </View>
    );
  }
