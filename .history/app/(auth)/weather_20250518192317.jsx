        ...
        <View style={styles.modalContainer}>
          ...
          <View style={styles.modalRow}>
            ...
            <Text style={styles.modalInfo}>
              {selectedHour.temp_c}°C (Se simte ca {selectedHour.feelslike_c}°C)
            </Text>
          </View>

          <View style={styles.modalRow}>
            <Feather name="wind" size={18} color="#333" />
            <Text style={styles.modalInfo}>
              {selectedHour.wind_kph} km/h • {selectedHour.wind_dir}
            </Text>
          </View>

          <View style={styles.modalRow}>
            <Feather name="droplet" size={18} color="#333" />
            <Text style={styles.modalInfo}>
              Umiditate: {selectedHour.humidity}%
            </Text>
          </View>

          <View style={styles.modalRow}>
            <Feather name="cloud-rain" size={18} color="#333" />
            <Text style={styles.modalInfo}>
              Precipitații: {selectedHour.precip_mm} mm • {selectedHour.chance_of_rain}%
            </Text>
          </View>
...
modalOverlay: {
  flex: 1,
  backgroundColor: "rgba(102, 107, 110, 0.5)",
  justifyContent: "center",
  alignItems: "center",
},
