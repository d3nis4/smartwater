...
function isDayTimeFromDateTime(hourDateTime, forecastDays) {
  ...
  const dayStr = hourDateTime.split(" ")[0];

  const matchingDay = forecastDays.find(day => day.date === dayStr);
...
const currentHourTime = weather.location.localtime; // sau altă sursă oră curentă
