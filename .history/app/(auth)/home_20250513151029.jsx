...
<View style={styles.modeSelector}>
  ...
  >
    <Ionicons
      ...
      color={pumpMode === "manual" ? "#fff" : "rgba(240, 187, 120, 1)"}
    />
    <Text
      style={[
...
const styles = StyleSheet.create({
 container: {
  ...
  cardIcon: {
    backgroundColor: Colors.SECONDARY_LIGHT + '20', // 20% opacity
    width: 40,
    height: 40,
    borderRadius: 12,
  ...
  activityIcon: {
    ...
    height: 36,
    borderRadius: 18,
    backgroundColor: Colors.SECONDARY_LIGHT + '20',
    justifyContent: "center",
    alignItems: "center",
    marginRight: 15,
  },
...
modeButtonActive: {
  backgroundColor: "rgba(240, 187, 120, 1)", // Culoare activă
},
