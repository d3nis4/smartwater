...
const getDynamicStyles = (tempC) => StyleSheet.create({
  text: {
    color: tempC > 10 ? 'rgba(48, 48, 48, 0.82)' : 'rgba(255,255,255,0.9)',
  }
});
...
const WeatherComponent = () => {
  ...
  const getTemperatureColors = (tempC) => {
    ...
    const colorPalettes = {
      hot: [
        'rgba(255, 82, 47, 0.84)',    // Roșu portocaliu
        'rgba(240, 152, 25, 0.85)',   // Portocaliu
        'rgba(255, 126, 95, 0.8)'     // Coral deschis
      ],
      warm: [
        'rgba(244, 208, 111, 0.46)',   // Verde mentă
        'rgba(255, 231, 194, 0.85)',  // Verde pastel
