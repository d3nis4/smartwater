...
const [showDeviceSetup, setShowDeviceSetup] = useState(false);
  ...
  // Handle back button (stable hook)
useEffect(() => {
  const backAction = () => {
    if (showDeviceSetup) {
      Alert.alert(
        "Renunți la configurare?",
        "Sigur vrei să renunți la configurare și să te întorci la profil?",
        [
          {
            text: "Nu",
            onPress: () => null,
          ...
          {
            text: "Da",
            onPress: () => setShowDeviceSetup(false)
          }
        ]
      );
      return true; // Spunem că am gestionat noi evenimentul back, să nu închidă aplicația
    }
    return false; // Permitem ieșirea normală din aplicație când nu suntem în configurare
  };
