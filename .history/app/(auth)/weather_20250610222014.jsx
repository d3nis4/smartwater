...
export default function  WeatherComponent(){
  ...
  if (tempC >= 30) return require('../../assets/images/backgrounds/hot.png');
  if (tempC >= 20) return require('../../assets/images/backgrounds/warm.png');
  if (tempC >= 10) return require('../../assets/images/backgrounds/cool.png');
  return require('.r./../assets/images/backgrounds/cold.png');
};
