      ...
      >
        {[7,14, 30].map((days) => (
          <TouchableOpacity
            key={days}
            style={{
              backgroundColor: selectedRange === days ? "{Colors.WHITE}" : "rgba(240, 187, 120, 1)",
              padding: 8,
              borderRadius: 8,
              marginHorizontal: 5,
            }}
          ...
          >
            <Text
              style={{
                color: selectedRange === days ? "rgba(255, 255, 255, 0.87)" : "rgba(255, 255, 255, 0.87)",
                fontWeight: "bold",
              }}
            >
              Ultimele {days} zile
...
const styles = StyleSheet.create({
  ...
  sectionTitle: {
    fontSize: 18,
    fontWeight: "600",
    color: Colors.DARKGREEN, // ex: titlu secțiune
  },
  statusRow: {
    flexDirection: "row",
    alignItems: "center",
