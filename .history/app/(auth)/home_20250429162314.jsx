import { Ionicons } from "@expo/vector-icons";pumpMode
...
const Home = () => {
  ...
  const [, setPumpMode] = useState("manual");
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      {!(overrideActive && pumpData?.pumpStatus === "off") && (
  <TouchableOpacity
    onPress={overrideActive ? handleOverrideStart : handleOverrideStop}
    style={{
      backgroundColor: overrideActive ? "#2ecc71" : "#e74c3c",
      padding: 12,
      borderRadius: 10,
      alignItems: "center",
      marginHorizontal: 20,
