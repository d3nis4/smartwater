...
logo: {
    width: 48,
    height: 48,
    tintColor: 'rgba(79, 32, 32, 0.9)',
},
// Add these new styles for modern effects
noiseOverlay: {
    ...StyleSheet.absoluteFillObject,
    backgroundColor: 'transparent',
    opacity: 0.03,
    backgroundImage: 'radial-gradient(circle, rgba(24, 60, 45, 0.8) 1px, transparent 1px)',
...
lightEffect: {
    ...
    height: 200,
    borderRadius: 100,
    backgroundColor: 'rgba(25, 94, 69, 0.69)',
    top: -100,
    right: -50,
