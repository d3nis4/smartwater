...
function isDayTimeFromDateTime(dateTimeStr, forecastDays) {
  ...
  const matchingDay = forecastDays.find((day) => day.date === datePart);
  ...
  const sunrise = new Date(year, month - 1, day, sunriseHour, sunriseMinute);
  const sunset = new Date(year, month - 1, day, sunsetHour, sunsetMinute);
