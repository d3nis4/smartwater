...
import { View, Text, TextInput,ScrollView, StyleSheet, TouchableOpacity,TouchableWithoutFeedback,Modal,Platform } from 'react-native';
...
const Register = () => {
  ...
  return (
    ...
    <ScrollViewView style={styles.container}>
