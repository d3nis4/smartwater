...
def get_weather_forecast(lat, lon):
    try:
        ...
        params = {
            ...
            'lang': 'en'  # Limba engleză pentru prognoză
        }
        ...
        if response.status_code == 200:
            ...
            print(f"[DEBUG] conditie curenta: {current_condition}")
            # Asigură-te că există date pentru prognoza pe zile
            if 'forecast' in weather_data and 'forecastday' in weather_data['forecast']:
                ...
                for day in weather_data['forecast']['forecastday']:
                    ...
                    # Verifică dacă există date pentru fiecare oră
                    if 'hour' in day:
                ...
                print("[ERROR] Datele pentru prognoza meteo sunt incomplete!")
                return None
        else:
